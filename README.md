...
- There a two components:
  ...
  1. The RedNotebook API service; This is a pre-requisite, you can get that from my repo [RedNotebook API](https://github.com/jendrikseipp/rednotebook). Based on FastAPI/Python, it reads and writes RedNotebook yyyy-mm.txt files, providing the API endpoints for the Android app. More info on the repo. I have mine running on a Orange Pi with Armbian, as a systemd service.

  2. This Android app.

- The Android app or the API endpoints do not feature any authentication. Exposing the API publicly to the Internet will make your journal entries available to anyone. Not a good idea.
